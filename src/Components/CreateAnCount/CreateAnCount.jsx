  ...
  return (
    <div className="auth-page-container">
      ...
      <div className="auth-hero-banner">
        {/* Render background panel mimicking the image_304d66.png design */}
        ...
        <div className="auth-hero-overlay">
          ...
          <div className="auth-hero-text-content">
            ...
            <p className="auth-hero-sub-text">
              Indulge your taste buds at MissMore, where every flavor tells a delicious story. Welcome to a MissMore journey like no other!
            </p>
            {/* Carousel Indicators */}
      ...
      <div className="auth-form-panel">
        <div className="auth-card-wrapper">
          ...
          {/* Alternative Auth Provider Breakpoint */}
